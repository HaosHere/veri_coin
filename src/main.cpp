...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "vericoin-4";
        CTransaction txNew;
        txNew.nTime = 1493622149;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1493605427;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = !fTestNet ? 1095339  : 1095339;
	...
	printf("block.GetHash() == %s\n", block.GetHash().ToString().c_str());
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0x14bfa0ddbf4c83faf06b5e678b2f742a840ad2ec8ee93b4b31fb1f10e8a34752"));
        block.print();
